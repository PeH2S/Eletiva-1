...
<div class="container mt-4">
    ...
    <form method="post">
        <?php for ($i = 0; $i < 5; $i++) { ?>
            ...
            <div class="mb-3">
                <label>Nota 1:</label>
                <input type="number" step="0.01" class="form-control" name="nota1<?php echo $i; ?>" >
            </div>
            <div class="mb-3">
                <label>Nota 2:</label>
                <input type="number" step="0.01" class="form-control" name="nota2<?php echo $i; ?>" >
            </div>
            <div class="mb-3">
                <label>Nota 3:</label>
                <input type="number" step="0.01" class="form-control" name="nota3<?php echo $i; ?>" >
            </div>
        <?php } ?>
